...
from fabfile import virt_dump_one_graph_nyc, virt_dump_one_graph_aws, backup_to_local, backup_to_aws, restore_rw,\
...
env.nyc_file = folder_timestamp + "-virtuoso-backup"
env.nyc_virtuoso_user="dba"
env.nyc_virtuoso_password="dba"


env.aws_dev_key_file="~/ttpem/aws-dev-cert.pem"
env.aws_host = 'virtuoso.a.dev.aws.3top.com'
env.aws_user = 'ubuntu'
env.aws_dir = "~/tmp/db_util/"
env.aws_file="3t-virt-inc_dump_#1.bp"
env.aws_virtuoso_user="dba"
env.aws_virtuoso_password="dba"
...
#print "Calling backup_to_local()..."
#srcdir = backup_to_local(env.nyc_user, env.nyc_host, env.local_backup_dir)
#print "Calling backup_to_aws()..."
#env.newdir = env.local_backup_dir + "/*"
#dstpath = backup_to_aws(env.aws_user, env.server_host_aws, env.newdir, env.aws_dev_key_file)
#restore_rw(env.aws_user, env.server_host_aws, env.aws_dev_key_file, graph1)
