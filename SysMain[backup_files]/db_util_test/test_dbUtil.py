...
_aws_swap_dir = PATH_ROOT + dict_ttSettings["PATH_LOG"] + "/dbUtil"
...
print "swapTimeStampDirPath: %s"%swapTimeStampDirPath
...
my_logger.debug("dict_ttSettings: %s"%dict_ttSettings)
...
try:
    from ttLib.ttVirtuoso import set_virtuoso_host, validate_virtuoso_aws_accounts, validate_virtuoso_nyc_target, virtuoso_operations
except:
...
def set_env(operation, t_env):
    ...
    try:
        ...
        my_logger.error("Error encountered in set_env. Exiting! ")
        sys.exit("Error encountered in set_env. Exiting!")
